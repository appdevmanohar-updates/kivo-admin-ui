...
import { LayoutDashboard, ShoppingBag, Package, Users, LogOut, Bell, Search, Menu, X, ChevronDown } from 'lucide-react';
  ...
  return (
    <div className="flex h-screen bg-black overflow-hidden font-sans selection:bg-corona-pink selection:text-white">
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden relative bg-black">
        {/* Background Gradients for ambient light */}
          ...
          <div className="flex items-center space-x-6 flex-1">
             ...
             <div className="relative w-full max-w-[240px] group hidden sm:block">
                ...
                <input 
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-[#191c24] border border-white/5 rounded-xl text-sm text-gray-300 focus:outline-none focus:border-corona-blue/50 focus:bg-[#191c24] focus:ring-1 focus:ring-corona-blue/50 transition-all placeholder-gray-600"
                />
             </div>
          </div>
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-3 pl-6 border-l border-white/10">
              <div className="text-right hidden md:block">
                <p className="text-sm font-semibold text-white">Henry Klein</p>
                <p className="text-[11px] text-gray-500 font-medium tracking-wide">GOLD MEMBER</p>
              </div>
